 ...
 * React Native components. Mirrors apps/web/src/lib/iconMap.tsx — every icon
 * name used by the preset registry, the custom-category picker, and wallet kinds.
 */
...
/** Color themes for custom categories. Class strings mirror web; swatch is the RN hex. */
