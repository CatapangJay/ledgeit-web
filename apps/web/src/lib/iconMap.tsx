import {
  ...
  Target,
  Money,
  // ─── Additional wallet-picker icons ─────────────────────────────────────────────
  Coins,
  Vault,
  Diamond,
  // ─── Fun / personality icons ─────────────────────────────────────────────────────
  Cat,
  Bird,
  Butterfly,
  Fish,
...
// ─── Wallet icon picker options ──────────────────────────────────────────────
// Phosphor icon names offered when customizing a wallet. Leads with the wallet
// kind defaults, then broader "what am I saving for" choices.
export const WALLET_ICON_OPTIONS: string[] = [
  // Kind defaults
  'PiggyBank',
  'TrendUp',
  'Lifebuoy',
  ...
  'Sparkle',
  'Umbrella',
  // Fun & cute — because wallets are personal
  'Cat',
  'Dog',
  'Rabbit',
  'PawPrint',
