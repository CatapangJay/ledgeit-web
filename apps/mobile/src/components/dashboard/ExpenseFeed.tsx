...
import { formatCurrencyCompact, formatDate, type Transaction } from '@ledgeit/core';
...
export default function ExpenseFeed() {
  ...
  return (
    <View className="overflow-hidden rounded-2xl" style={{ backgroundColor: '#ffffff', shadowColor: '#00352e', shadowOpacity: 0.06, shadowRadius: 16, elevation: 1 }}>
      <View className="flex-row items-center justify-between px-5 pb-3 pt-4">
        <Text className="text-[11px] font-bold uppercase tracking-[1.6px]" style={{ color: '#3f4946' }}>
          Recent Activity
        </Text>
            ...
            return (
              ...
              >
                ...
                <View className="min-w-0 flex-1">
                  ...
                  <Text className="mt-0.5 text-[11px]" style={{ color: '#8eaeaa' }} numberOfLines={1}>
          ...
          <Link href="/history" asChild>
            ...
            >
              ...
              <View className="flex-row items-baseline gap-1.5">
                <Text className="text-[11px] font-semibold" style={{ color: '#8eaeaa' }}>
                  Net this month
                </Text>
